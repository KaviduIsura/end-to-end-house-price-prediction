...
console.log(import.meta.env.VITE_API_BASE_URL);
      ...
      if (response.data && response.data.success !== false) {
        ...
        if (price !== undefined) {
          setPrediction({
            price: price,
            locationUsed:
              response.data.location_column ||
              response.data.location_used ||
              "",
            availabilityEncoded:
              response.data.availability_value ||
              response.data.availability_encoded ||
              0,
  ...
  const getPricePerSqft = () => {
    if (!prediction || !formData.total_sqft || formData.total_sqft <= 0)
      return 0;
    ...
    <div className="max-w-6xl px-4 py-12 mx-auto">
      <div className="mb-12 text-center">
        ...
        <p className="max-w-2xl mx-auto section-subtitle">
          Get accurate property valuations powered by machine learning. Our AI
          analyzes thousands of data points for precise predictions.
        </p>
      </div>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                <div
                                  className={`p-1.5 rounded-md ${getTierColor(
                                    location.tier
                                  )}`}
                                >
                ...
                <div className="space-y-3">
                  <div className="flex items-start">
                    ...
                    <span className="text-sm text-gray-300">
                      This price is competitive for a {getCurrentLocationTier()}{" "}
                      tier location
                    </span>
                  </div>
                  <div className="flex items-start">
                    ...
                    <span className="text-sm text-gray-300">
                      Consider similar properties in nearby areas for better
                      deals
                    </span>
                  </div>
                </div>
            ...
            <div className="card bg-gradient-to-br from-dark-800/50 to-dark-900/30">
              <div className="py-12 text-center">
                ...
                <p className="mb-8 text-gray-400">
                  Fill in your property details to get an AI-powered price
                  prediction.
                </p>
              ...
              {[
                {
                  ...
                  desc: "Analyzes recent sales in the area",
                },
                {
                  title: "Feature Weighting",
                  desc: "Assigns value to each property feature",
                },
                {
                  title: "Trend Prediction",
                  desc: "Forecasts market direction",
                },
                {
                  title: "Location Scoring",
                  desc: "Evaluates neighborhood quality",
                },
              ].map((insight, index) => (
